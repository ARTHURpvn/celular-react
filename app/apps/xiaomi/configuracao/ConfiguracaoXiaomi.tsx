...
const ConfiguracaoXiaomi = () => {
    const { dispatch, isAppClosing } = useCellphoneContext();
    ...
    <div className={`dark:bg-black bg-white h-full w-full  ${isAppClosing && 'scale-50 translate-y-full'} transition-all duration-500`}>
...
export default ConfiguracaoXiaomi;